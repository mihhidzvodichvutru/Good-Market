...
getContractFactory(name: 'BODOINFT', signerOrOptions?: ethers.Signer | FactoryOptions): Promise<Contracts.BODOINFT__factory>
...
getContractAt(name: 'BODOINFT', address: string | ethers.Addressable, signer?: ethers.Signer): Promise<Contracts.BODOINFT>

  deployContract(name: 'NFTMarketplace', signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.NFTMarketplace>
deployContract(name: 'BODOINFT', signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.BODOINFT>
...
deployContract(name: 'BODOINFT', args: any[], signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.BODOINFT>
