        ...
        <div className="flex items-center gap-3">
          ...
          {isLandingPage ? (
            ...
            <>
              ...
              {/* Vùng Ví / Avatar (ĐÃ ĐƯỢC CHỈNH CSS GIỐNG HỆT ẢNH) */}
              {walletAddress === "" ? (
                <button
                    ...
                    <div className="absolute right-0 mt-3 w-64 rounded-[20px] bg-[#1a202c] border border-gray-700 shadow-[0_10px_40px_rgba(0,0,0,0.5)] overflow-hidden animate-in fade-in slide-in-from-top-2 z-50">
                      ...
                      <div className="p-2 flex flex-col gap-1">
                        <Link 
                          ...
                          className="flex items-center gap-3 w-full px-3 py-3 text-sm font-semibold text-gray-300 rounded-xl hover:bg-gray-800 hover:text-white transition-colors"
                        >
                          <User size={18} />
                      ...
                      <div className="p-2 border-t border-gray-700">
                        <button 
                          ...
                          className="flex items-center gap-3 w-full px-3 py-3 text-sm font-bold text-[#ff6b6b] rounded-xl hover:bg-red-500/10 hover:text-red-400 transition-colors"
                        >
                          <LogOut size={18} />
                          Log Out
                        </button>
