...
export default function ImageExplorePage() {
...
// 📦 HÀM DÀNH RIÊNG CHO TRANG IMAGE: Chỉ chứa UI của Hình ảnh
  const renderNFTCard = (nft: NFT) => (
    <Link href={`/explore/${nft.id}`} key={`image-card-${nft.id}`} className="group flex flex-col rounded-3xl bg-gray-800 border border-gray-700 overflow-hidden hover:-translate-y-2 hover:shadow-[0_10px_40px_rgba(37,99,235,0.2)] transition-all duration-300">
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mb-10">
          ...
          <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight mb-4 flex items-center gap-4">
            <Camera className="text-blue-400" size={40} /> Hình ảnh Nổi bật
          </h1>
          <p className="text-gray-400 text-lg max-w-2xl">
            Khám phá bộ sưu tập Hình ảnh nghệ thuật độc bản được lưu trữ trên Blockchain.
          </p>
        </div>
